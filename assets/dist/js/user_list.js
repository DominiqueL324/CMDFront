    ...
    $.ajax({
        ...
        success: function(response){
            ...
            response['results'].forEach(elt => {
                ...
                if(elt["groups"][0]["group"] == "Agent secteur" || elt["groups"][0]["group"] == "Agent constat"|| elt["groups"][0]["group"] == "Audit planneur" ) {
                    id_toget = elt["agent"]
                }
                ...
                $('#contentTableUser').append(
                    '<tr>\
                        <td>'+i+'</td>\
                        <td>'+ elt["first_name"] +' '+elt["last_name"] +'</td>\
                        <td>'+ elt["email"]+'</td>\
                        <td class="text-center">\
                            <span class="badge badge-success">'+elt["groups"][0]["group"]+'</span>\
                        </td>\
                        <td>'+ societe +'</td>\
                        <td>\
